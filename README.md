...
In step 2, we presented the tools in Docker containers. If the reviwers complet all the steps uptp know you have succfully executed the tools and observed that the tools are functional and data and tools are publically available. Now, let's examine the tools are reusable. 
