...
In step 2, we presented the tools in Docker containers. However, If reviewers want to build the tools and perform customization or use them as submodules we have given detailed instructions in the tools’ GitHub repositories. Apart from that, the Py-RefactoringMiner is available in the maven repository with the following dependency information. 
